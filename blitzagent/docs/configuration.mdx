---
title: "Configuration"
description: "Advanced configuration options for BlitzAgent deployment and optimization"
---

# Configuration

This guide covers advanced configuration options for BlitzAgent, including production deployment settings, performance optimization, and customization options.
...
<AccordionGroup>
  ...
  <Accordion icon="clock" title="Timeout Configuration">
    **Request Timeouts**:
    ...
    ANTHROPIC_TIMEOUT = 60  # Claude API timeout
