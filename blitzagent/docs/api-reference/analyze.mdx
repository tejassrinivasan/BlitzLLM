...
The `/analyze` endpoint is the primary way to interact with Blitz. It accepts natural language sports queries and returns comprehensive analysis powered by advanced reasoning LLM models and comprehensive sports data.
