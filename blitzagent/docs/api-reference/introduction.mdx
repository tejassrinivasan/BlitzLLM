...
Blitz provides a powerful REST API for sports analysis powered by Claude 4 Sonnet. This API enables you to perform complex sports analytics queries with natural language processing and integrate sports intelligence into your applications and agent workflows.
...
class BlitzClient {
  constructor(apiKey, baseUrl = 'https://api.blitz.com') {
    this.apiKey = apiKey;
